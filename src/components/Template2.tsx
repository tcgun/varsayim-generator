            ...
            <div className="relative flex-1 flex flex-col w-full h-full">
                ...
                <div className="absolute top-0 left-0 p-4 z-60 flex flex-col items-start gap-2">
                    <div className="bg-[#FFD700] text-black border-[3px] border-black shadow-[4px_4px_0px_#000] px-6 py-2">
                        <span
                            className={`tracking-tighter uppercase text-black leading-none`}
                ...
                <div className={`relative z-10 flex-1 flex flex-col items-center ${isWide ? 'justify-center p-12' : isSquare ? 'justify-end pb-8 px-6' : 'justify-end pb-8 px-4'} text-white`}>
                    ...
                    {isSquare && (
                        <div className="w-full flex flex-col gap-4 max-w-5xl">
                            <div className="w-full bg-black/30 backdrop-blur-3xl border-t-4 border-t-white p-3 flex flex-col items-center shadow-2xl border-x border-b border-white/5">
                                <span
                                    className={`font-bold opacity-90 mb-3 uppercase tracking-widest text-white`}
                            ...
                            <div className="space-y-4 w-full">
                                <div className="grid grid-cols-2 gap-4">
                                    <div className="bg-black/30 backdrop-blur-3xl border-t-4 border-t-v-yellow p-3 flex flex-col items-center justify-center text-center shadow-[0px_0px_30px_rgba(250,204,21,0.2)] border-x border-b border-white/5">
                                    ...
                                    <div className="bg-black/30 backdrop-blur-3xl border-t-4 border-t-red-500 p-3 flex flex-col items-center justify-center text-center shadow-[0px_0px_30px_rgba(239,68,68,0.2)] border-x border-b border-white/5">
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    <div className="bg-yellow-400/10 backdrop-blur-3xl border-t-2 border-t-yellow-400 p-2 flex flex-col items-center border-x border-b border-white/5">
                                    ...
                                    <div className="bg-red-500/10 backdrop-blur-3xl border-t-2 border-t-red-500 p-2 flex flex-col items-center border-x border-b border-white/5">
                                    ...
                                    <div className="bg-white/5 backdrop-blur-3xl border-t-2 border-t-white p-2 flex flex-col items-center border-x border-b border-white/5">
                                    ...
                                    <div className="bg-v-pink/10 backdrop-blur-3xl border-t-2 border-t-v-pink p-2 flex flex-col items-center border-x border-b border-white/5">
                    ...
                    {isWide && (
                        <div className="flex flex-row items-center justify-between w-full max-w-full px-4 mt-8 flex-1">
                            ...
                            <div className="w-[35%] flex flex-col gap-4 items-center justify-center">
                                <div className="w-full bg-black/30 backdrop-blur-3xl border-t-4 border-t-white p-5 flex flex-col items-center justify-center text-center shadow-2xl border-x border-b border-white/5">
                                ...
                                <div className="w-full bg-black/30 backdrop-blur-3xl border-t-4 border-t-v-yellow p-5 flex flex-col items-center justify-center text-center shadow-[0px_0px_30px_rgba(250,204,21,0.2)] border-x border-b border-white/5">
                                ...
                                <div className="w-full bg-black/30 backdrop-blur-3xl border-t-4 border-t-red-500 p-5 flex flex-col items-center justify-center text-center shadow-[0px_0px_30px_rgba(239,68,68,0.2)] border-x border-b border-white/5">
                    ...
                    {isWide && (
                        <div className="w-full max-w-6xl mt-8 px-12 mb-8">
                            <div className="grid grid-cols-4 gap-4">
                                <div className="bg-yellow-400/20 backdrop-blur-3xl border-t-4 border-t-yellow-400 p-4 flex flex-col items-center justify-center text-center shadow-[0px_0px_20px_rgba(250,204,21,0.2)] overflow-hidden border-x border-b border-white/5">
                                ...
                                <div className="bg-red-500/20 backdrop-blur-3xl border-t-4 border-t-red-500 p-4 flex flex-col items-center justify-center text-center shadow-[0px_0px_20px_rgba(239,68,68,0.2)] overflow-hidden border-x border-b border-white/5">
                                ...
                                <div className="bg-white/10 backdrop-blur-3xl border-t-4 border-t-white p-4 flex flex-col items-center justify-center text-center shadow-2xl overflow-hidden border-x border-b border-white/5">
                                ...
                                <div className="bg-v-pink/20 backdrop-blur-3xl border-t-4 border-t-v-pink p-4 flex flex-col items-center justify-center text-center shadow-[0px_0px_20px_rgba(244,114,182,0.2)] overflow-hidden border-x border-b border-white/5">
                    ...
                    {isPortrait && !isSquare && (
                        <div className="w-full">
                            <div className="space-y-6">
                                <div className="bg-black/30 backdrop-blur-3xl border-t-4 border-t-white p-6 flex flex-col items-center justify-center text-center shadow-2xl border-x border-b border-white/5">
                                    <span style={{ fontSize: `${statLabelPx * 1.5}px` }} className="font-bold opacity-90 mb-4 uppercase tracking-widest">TOPLAM GÖREV</span>
                                ...
                                <div className="grid grid-cols-2 gap-6">
                                    <div className="bg-black/30 backdrop-blur-3xl border-t-4 border-t-v-yellow p-8 flex flex-col items-center justify-center text-center shadow-[0px_0px_30px_rgba(250,204,21,0.2)] border-x border-b border-white/5">
                                        <span style={{ fontSize: `${statLabelPx}px` }} className="font-bold opacity-90 mb-2 uppercase tracking-wider">VAR MÜDAHALESİ</span>
                                        <span style={{ fontSize: `${statValuePx * 1.2}px` }} className="font-black text-v-yellow leading-none tracking-tighter drop-shadow-2xl">{stats.varGo || "0"}</span>
                                    </div>
                                    <div className="bg-black/30 backdrop-blur-3xl border-t-4 border-t-red-500 p-8 flex flex-col items-center justify-center text-center shadow-[0px_0px_30px_rgba(239,68,68,0.2)] border-x border-b border-white/5">
                                ...
                                <div className="grid grid-cols-2 gap-6 pb-12">
                                    <div className="bg-yellow-400/10 backdrop-blur-3xl border-t-2 border-t-yellow-400 p-6 flex flex-col items-center border-x border-b border-white/5">
                                    ...
                                    <div className="bg-red-500/10 backdrop-blur-3xl border-t-2 border-t-red-500 p-6 flex flex-col items-center border-x border-b border-white/5">
                                    ...
                                    <div className="bg-white/5 backdrop-blur-3xl border-t-2 border-t-white p-6 flex flex-col items-center border-x border-b border-white/5">
                                    ...
                                    <div className="bg-v-pink/10 backdrop-blur-3xl border-t-2 border-t-v-pink p-6 flex flex-col items-center border-x border-b border-white/5">
